...
public enum StaticEmoji {
    ...
    public static StaticEmoji from(String unicode) {
        for(StaticEmoji emoji : StaticEmoji.values()) {
            String emojicode = emoji.getValue();
            if(unicode.equalsIgnoreCase(emojicode))
                return emoji;
        }
        return null;
    }
	...
	public Unicode re() {
		return ReactionEmoji.unicode(value);
	}
